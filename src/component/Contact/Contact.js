						...
						<div className='left'>
							<div className='box box_shodow'>
								<div className='img_area'>
									<img src={Data.photo.contactImg} alt='' />
								</div>
								<div className='details'>
									<h1>Chayan Roy</h1>
									<p>I am rady for internsheep work. Connect with me with phone call or send email.</p> <br />
									<p>Phone: +917003103509</p>
									<p>Email: chayanthe01guy@gmail.com</p> <br />
